...
public class IOToFileUtils {
	...
	/**
	 * 以字节为单位读取文件，常用于读取二进制文件，如：图片、声音、影像等 <请替换成功能描述> <br>
	 * <请替换成详细描述>
	 * 
	 * @param fileName
	 * @author caizh
	...
	/**
	 * 以字符为单位读取文件，常用于读取文本，数字等类型的文件 <请替换成功能描述> <br>
	 * <请替换成详细描述>
	 * 
	 * @param fileName
	 * @author caizh
	...
	/**
	 * 以行为单位读取文件，常用于读取面向行的格式化文件 <请替换成功能描述> <br>
	 * <请替换成详细描述>
	 * 
	 * @param fileName
	 * @author caizh
	...
	/**
	 * 将内容追加到文件尾部 A方法：使用RandomAccessFile <请替换成功能描述> <br>
	 * <请替换成详细描述>
	 * 
	 * @param fileName
	 *            包含完整路径的文件名
	...
	/**
	 * 将内容追加到文件尾部 B方法：使用FileWriter <请替换成功能描述> <br>
	 * <请替换成详细描述>
	 * 
	 * @param fileName
	 * @param content
	...
	/**
	 * 将内容追加到文件尾部 C方法：使用BufferedWriter <请替换成功能描述> <br>
	 * <请替换成详细描述>
	 * 
	 * @param fileName
	 * @param content
